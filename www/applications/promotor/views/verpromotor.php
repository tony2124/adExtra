<legend><span class="glyphicon glyphicon-dashboard"></span>&nbsp;&nbsp;Mis datos <a style="margin-left: 10px" onclick="goBack()" class="btn btn-primary pull-right btn-sm" href="#"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></legend>
...
<?php foreach ($historial as $historia) { ?>
    <tr>
      <td><a href="<?php print get("webURL")."/promotor/index/".$historia['per'] ?>"> <?php print $historia['per']  ?></a></td>
